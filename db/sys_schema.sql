...
-- ----------------------------
BEGIN;
INSERT INTO `tb_log` VALUES (1, 'admin', '查看用户列表', 20, 'cn.shoesstem.controller.UserController.queryList()', ' queryPage\"QueryPage(pageCode=1, pageSize=6)\" user\"User(id=null, username=null, password=null, salt=null, deptId=null, deptName=null, createTime=null, modifyTime=null, avatar=null, phone=null, sex=null, description=null, status=null)\"', '127.0.0.1', '2019-03-13 00:42:34', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (7, 'admin', '更新用户', 83, 'cn.shoesstem.controller.UserController.update()', ' user\"UserWithRole(roleId=1, roleIds=[1])\"', '127.0.0.1', '2019-03-13 01:21:48', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (10, 'admin', '删除用户', 65, 'cn.shoesstem.controller.UserController.delete()', ' ids\"[9]\"', '127.0.0.1', '2019-03-13 05:00:56', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (11, 'admin', '删除用户', 9, 'cn.shoesstem.controller.UserController.delete()', ' ids\"[9]\"', '127.0.0.1', '2019-03-13 05:01:18', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (12, 'admin', '删除登录日志', 39, 'cn.shoesnitor.controller.LoginLogController.delete()', ' ids\"[3]\"', '127.0.0.1', '2019-03-13 05:13:03', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (13, 'admin', '删除日志', 44, 'cn.shoesnitor.controller.LogController.delete()', ' ids\"[8]\"', '127.0.0.1', '2019-03-13 05:15:54', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (14, 'admin', '删除日志', 9, 'cn.shoesnitor.controller.LogController.delete()', ' ids\"[9]\"', '127.0.0.1', '2019-03-13 05:15:58', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (15, 'admin', '删除七牛云文件', 378, 'cn.shoesorage.controller.QiniuController.delete()', ' name\"ss1074261491006988288.jpg\"', '127.0.0.1', '2019-03-13 08:30:31', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (16, 'admin', '更新七牛云文件名', 430, 'cn.shoesorage.controller.QiniuController.update()', ' oldname\"ss1074213185631420416.png\" newname\"1074213185631420416.png\"', '127.0.0.1', '2019-03-13 08:32:56', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (17, 'admin', '上传七牛云文件', 1948, 'cn.shoesorage.controller.QiniuController.upload()', ' file\"org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@576e7f4b\" request: org.springframework.web.multipart.support.StandardMultipartHttpServletRequest@5ac44dd6', '127.0.0.1', '2019-03-13 19:14:19', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (18, 'admin', '添加用户', 96, 'cn.shoesstem.controller.UserController.add()', ' user\"UserWithRole(roleId=null, roleIds=[3])\"', '127.0.0.1', '2019-03-14 08:27:07', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (19, 'admin', '文件上传', 7, 'cn.shoesorage.controller.UploadController.upload()', ' file\"org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@150e5550\" request: org.springframework.web.multipart.support.StandardMultipartHttpServletRequest@38af3773', '127.0.0.1', '2019-03-14 08:27:50', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (20, 'admin', '更新用户', 19, 'cn.shoesstem.controller.UserController.update()', ' user\"UserWithRole(roleId=3, roleIds=[3])\"', '127.0.0.1', '2019-03-14 08:28:01', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (21, 'admin', '上传七牛云文件', 2087, 'cn.shoesorage.controller.QiniuController.upload()', ' file\"org.springframework.web.multipart.support.StandardMultipartHttpServletRequest$StandardMultipartFile@367a9b8b\" request: org.springframework.web.multipart.support.StandardMultipartHttpServletRequest@322fa353', '127.0.0.1', '2019-03-14 08:29:17', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (22, 'admin', '更新用户', 19, 'cn.shoesstem.controller.UserController.update()', ' user\"UserWithRole(roleId=3, roleIds=[3])\"', '127.0.0.1', '2019-03-14 08:29:21', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (23, 'shoes', '添加用户', 22, 'cn.shoesstem.controller.UserController.add()', ' user\"UserWithRole(roleId=null, roleIds=[2])\"', '127.0.0.1', '2019-03-15 22:54:35', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `tb_log` VALUES (24, 'shoes', '更新用户', 22, 'cn.shoesstem.controller.UserController.update()', ' user\"UserWithRole(roleId=2, roleIds=[2])\"', '127.0.0.1', '2019-03-15 22:56:35', '内网IP|0|0|内网IP|内网IP');
COMMIT;
...
INSERT INTO `tb_login_log` VALUES (22, 'shoes', '127.0.0.1', '内网IP|0|0|内网IP|内网IP', '2019-03-15 21:51:47', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36');
...
INSERT INTO `tb_login_log` VALUES (25, 'shoes', '127.0.0.1', '内网IP|0|0|内网IP|内网IP', '2019-03-15 22:49:37', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Safari/537.36');
COMMIT;
...
INSERT INTO `tb_user` VALUES (2, 'shoes', '18caf8ff1512ad84f46053ac0f4561cf', 'ab2874470d60b14ed8f1248ab0e527ad', 5, '2019-01-01 00:00:00', '2019-02-05 02:47:26', '/img/avatar/20180414165754.jpg', '18798797687', '0', '测试账号，可查看所有页面', 1);
